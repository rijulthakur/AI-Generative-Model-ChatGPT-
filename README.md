...
## Architecture
- **Client:** React.js which handles user interface and conversation state
- **Server:** Node.js with Express that manages API routing and request 
  handling
...
client hence decoupling the UI from the AI inference layer.
